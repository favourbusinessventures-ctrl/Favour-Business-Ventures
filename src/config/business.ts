/**
 * Business Configuration for FAVOUR BUSINESS VENTURES
...
export const BUSINESS_CONFIG = {
  ...
  defaultOrderMessage: "Hello Favour Business Ventures, I would like to place an order for stockfish and crayfish. Please share available options and pricing.",
