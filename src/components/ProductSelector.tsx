      ...
      >
        ...
        <div className="pt-2">
          <a
            ...
            className={`btn-tactile w-full sm:w-auto inline-flex items-center justify-center gap-3 px-9 py-4 text-xs font-semibold tracking-[0.2em] uppercase shadow-md group rounded-[2px] ${
              isDark
                ? 'bg-[#B8954A] hover:bg-[#C9A75E] text-[#071F16]'
                : 'bg-[#071F16] hover:bg-[#0D3325] text-[#F5F0E6] border border-[#B8954A]/30'
            }`}
          >
            <MessageCircle
            ...
            <ArrowUpRight
              className={`w-3.5 h-3.5 transition-transform group-hover:translate-x-1 group-hover:-translate-y-0.5 ${
                isDark ? 'text-[#071F16]/80' : 'text-[#F5F0E6]/70'
              }`}
            />
          </a>
        </div>
